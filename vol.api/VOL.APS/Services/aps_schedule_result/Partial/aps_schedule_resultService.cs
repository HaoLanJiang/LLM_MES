/*
 *所有关于aps_schedule_result类的业务代码应在此处编写
*可使用repository.调用常用方法，获取EF/Dapper等信息
*如果需要事务请使用repository.DbContextBeginTransaction
*也可使用DBServerProvider.手动获取数据库相关信息
*用户信息、权限、角色等使用UserContext.Current操作
*aps_schedule_resultService对增、删、改查、导入、导出、审核业务代码扩展参照ServiceFunFilter
*/
...
namespace VOL.APS.Services
{
    public partial class aps_schedule_resultService
    {
        ...
        private readonly Iaps_schedule_resultRepository _repository;//访问数据库
