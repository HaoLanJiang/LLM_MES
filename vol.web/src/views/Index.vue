            ...
            <div class="vol-header">
                ...
                <div class="header-text">
                    ...
                    <div class="h-link" v-if="layout == 'top'">
                        <a :class="[navCurrentMenuId === item.id ? 'h-link-a-acitve' : '']"
            ...
            <div class="vol-path">
                <el-tabs @tab-click="selectNav" @tab-remove="removeNav" type="border-card" class="header-navigation"
                    ...
                    <el-tab-pane v-for="(item, navIndex) in navigation" type="card" :name="navIndex + ''"
                        :closable="navIndex > 0" :key="navIndex" :label="$ts(item.name)">
                ...
                <div v-show="contextMenuVisible">
                    <ul :style="{ left: menuLeft + 'px', top: menuTop + 'px' }" class="contextMenu">
                        <li v-show="visibleItem.left">
                            <el-button link @click="navCloseTabs('left')"><i class="el-icon-back"></i>{{ $ts('关闭左边')
                            }}</el-button>
                        </li>
